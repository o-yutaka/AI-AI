...
def estimate_throughput(*, candidate_seconds: float, budget_seconds: float, success_probability: float) -> ThroughputEstimate:
    ...
    return ThroughputEstimate(candidate_seconds, budget_seconds, completed, completed * success_probability)
